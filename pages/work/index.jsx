   ...
   <main className="text-[1.6rem] font-[400] text-[#000] leading-[2.6rem] relative">
    ...
    <section className='py-[10rem]'>
        ...
        <div className='mt-[5rem] flex flex-row items-center gap-x-[5rem]'>
            <div className='w-[56.1rem] h-[40rem] relative' >
                <Image 
            ...
            <div className='mt-[3.5rem] w-[16rem] h-[5.8rem]'>
    ...
    <section className='py-[10rem] bg-[#fafafa]'>
        ...
        <div className='mt-[5rem] gap-x-[3.3rem] gap-y-[5rem] gridStyle'>
            {
    ...
    <section className='py-[10rem]'>
       ...
       <div className='w-[90rem] mx-auto mt-[5rem]'>
       <div className='w-full h-[50rem] relative' >
        ...
        <h1 className="font-[500] text-[2.5rem] leading-[2.5rem] my-[2.5rem]">A Vision for Change: Proposed SlumTech Institute Aims to Provide Free
       ...
       seeks to empower marginalized youth, equipping them with essential skills to thrive in today’s technology-driven world.
        ...
        <p className='mt-[2.5rem]'>The proposal comes in response to the clear need for accessible educational resources in slum regions, 
