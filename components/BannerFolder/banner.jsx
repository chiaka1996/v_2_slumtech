...
const Banner = ({img }) => {
    ...
    return(
      ...
      //   className={`relative pt-[10rem] flex items-center justify-center min-h-[100vh] max-small:min-h-[100vh] w-full bg-cover max-small:bg-center bg-no-repeat`}
      //  >
      //   <video muted loop autoPlay playsInline disablePictureInPicture
      //   className='absolute top-[-15.9vh] left-0 w-full min-h-[100vh] max-small:min-h-full z-[-1] bg-cover'
      //   >
