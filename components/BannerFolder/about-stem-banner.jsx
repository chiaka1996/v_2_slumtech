    ...
    return(
       ...
       >
        <div className="relative container text-center pt-[10rem]" >
            <h2 className='font-[700] text-[4.8rem] leading-[6.4rem] text-[#F5B021] opacity-0 bigHeader'>About Us</h2>
            <h3 className='font-[400] text-[1.8rem] leading-[3rem] text-[#fff] max-w-[819px] mx-auto opacity-0 subHeader'>
        ...
        <div className='max-w-[1100px] min-h-[560px] rounded-[20px] mx-auto opacity-0 aboutVideo'>
