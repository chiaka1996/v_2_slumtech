...
import { topToBottomAnimation } from "../../utilis/animations";
import Button from "../Button/btn.jsx";

const JoinUs = () => {
    useEffect(() => {
        topToBottomAnimation(".join-us")
    })
    return(
    <section className="bg-[url('/v_3_images/join-us.png')] bg-cover bg-center h-[54.2rem] max-small:h-[50rem] w-full text-[#fff]">
    <div className='container relative'>
    <div className='join-us max-w-[48.5rem] max-small:pt-[5rem] max-small:max-w-full small:absolute small:right-0 small:top-[7.7rem] flex flex-col gap-y-[2rem]'>
