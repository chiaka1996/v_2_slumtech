...
const Footer = () => {
    return(
        <footer className='bg-[#3A1667] w-[100%] text-[#fff] text-center pt-[38.1rem]'>
          <div className='container'>
            <div className="relative h-[7.5rem] w-[177px] mx-auto">
              <Image 
              src="/v_3_logo/logo2.png"
              fill
              alt="slumtech logo"
                />
            </div>
            <div className='mt-[5rem] font-[500] text-[1.8rem] leading-[3rem] flex flex-row gap-x-[5rem] justify-center'>
              <span>Home</span>
              <span>About Us</span>
              <span>Contact Us</span>
            </div>

            <div className='py-[2.4rem] mt-[6rem] border border-t-[#FFFFFF40] border-x-0 border-b-0 flex flex-row justify-between'>
