...
const GetInTouch = ({img }) => {
    useEffect(() => {
        bottomToTopAnimation(".get-in-touch")
    }, [])
    ...
    return(
       ...
       >
        <div className='container'>
            <div className='ml-auto max-w-[628px] flex flex-col gap-y-[2rem] get-in-touch'>
            ...
            <p className='font-[500] text-[2rem] max-small:text-[1.6rem] leading-[32px] max-small:leading-[2.4rem]'>
            ...
            <p className='font-[600] text-[30px] max-small:text-[2rem] leading-[42px] max-small:leading-[32px]'>Together, let’s build a tech-savvy future for everyone</p>
