...
const Programs = ({img }) => {
    useEffect(() => {
        ...
        bottomToTopAnimation(".program-grid")
    ...
    return(
       <section 
        className={`font-[400] text-[1.6rem] max-small:text-[1.4rem] leading-[2.4rem] pt-[12rem] max-small:py-[5rem] w-full`}
       >
        <div className='container'>
        <h1 className='font-[600] text-[4.8rem] max-small:text-[3rem] leading-[62px] max-small:leading-[3.2rem] text-center programHeader'>
            <span className='text-[#004658]'>Our</span><span className='text-[#0C9D69]'> Programs</span>
        </h1>

        <div className='mt-[5rem] max-small:mt-[3rem] gridStyle gap-[3rem] program-grid'>
            <div className='bg-[#F5F5F5] rounded-[20px]'>
                <div className='relative w-full h-[30.8rem] max-small:h-[20.2rem] rounded-[20px]'>
                 <Image 
            ...
            />
                ...
                <div className='py-[2rem] px-[2.5rem] rounded-[20px]'>
                    <h2 className='text-[#004658] font-[700] text-[2.4rem] max-small:text-[1.8rem] max-small:leading-[2.4rem] leading-[31px]'>STEM Competitions</h2>
                    <p className='leading-[3rem] text-[1.8rem] max-small:text-[1.4rem] max-small:leading-[2rem]'>
            ...
            />
                ...
                <div className='py-[2rem] px-[2.5rem] rounded-b-[20px]'>
                    <h2 className='text-[#004658] font-[700] text-[2.4rem] max-small:text-[1.8rem] max-small:leading-[2.4rem] leading-[31px]'>Free Technology Courses and Training Platform</h2>
                    <p className='leading-[3rem] text-[1.8rem] max-small:text-[1.4rem] max-small:leading-[2rem]'>
            ...
            />
                ...
                <div className='py-[2rem] px-[2.5rem] rounded-[20px]'>
                    <h2 className='text-[#004658] font-[700] text-[2.4rem] max-small:text-[1.8rem] max-small:leading-[2.4rem] leading-[31px]'>Mentorship from Tech Professionals Worldwide</h2>
                    <p className='leading-[3rem] text-[1.8rem] max-small:text-[1.4rem] max-small:leading-[2rem]'>
