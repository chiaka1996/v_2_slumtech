...
const UpcomingEvents = ({img }) => {
    ...
    return(
       <section 
        className={`pb-[12rem] font-[400] text-[1.6rem] leading-[2.4rem] max-small:pt-0 flex items-center justify-center w-full`}
       >
        <div className="relative container text-center">
            ...
            <div className='gridStyle mt-[5rem] gap-x-[5rem] text-left text-[#fff]'>
