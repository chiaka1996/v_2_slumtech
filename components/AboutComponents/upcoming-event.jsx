...
const UpcomingEvents = ({img }) => {
    useEffect(() => {
      ...
      bottomToTopAnimation(".upcomingSubHeader")
      bottomToTopAnimation(".events")
    ...
    return(
       ...
       >
        <div className="relative container text-center">
            <MainHeader text="Upcoming Events" classname="upcomingHeader"/>
            <div className='upcomingSubHeader text-[1.8rem] mt-[1rem] font-[400] text-[#7E7E7E] max-w-[106rem] mx-auto'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
             et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
            </div>

            <div className='events gridStyle mt-[5rem] max-small:mt-[3rem] gap-x-[5rem] gap-y-[3rem] text-left text-[#fff]'>
