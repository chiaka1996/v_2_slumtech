    ...
    return(
     ...
     >
        ...
        <div className='max-w-[878px] pt-[12rem] max-small:pt-[5rem] mx-auto text-center max-small:px-[1rem]'>    
            <h2 className='font-[700] text-[54px] max-small:text-[3rem] leading-[64px] max-small:leading-[3.2rem] text-[#004658]'>About the Competition</h2>
            <div className='text-[18px] max-small:mt-[0.5rem] max-small:text-[1.4rem] max-small:leading-[2.2rem] mb-[3rem] max-small:mb-[1.5rem]'>
            ...
            to transform their ideas into tangible solutions.
             ...
             <button className='mx-auto gap-x-[1.5rem] flex flex-row justify-center items-center w-[198px]  max-small:w-[137px] h-[50px] max-small:h-[40px] rounded-[25px] bg-[#F5B021] text-[700] text-[#000] font-[500] text-[18px] max-small:text-[1.4rem] leading-[3rem]'>
              <span>Join now</span>
