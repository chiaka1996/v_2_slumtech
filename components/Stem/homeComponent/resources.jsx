       ...
       <div className='container py-[12rem] max-small:py-[5rem]'>
          <div className=''>
           ...
           <div className='gridStyle gap-[3rem] mt-[5rem] max-small:mt-[3rem]'>
            ...
            <h3 className='font-[700] font-basic text-[2rem] max-small:text-[1.8rem] text-[#004658]'>Guidelines and Rules</h3>
            <ul className='text-[1.6rem] max-small:text-[1.4rem] list-disc ml-[2rem] flex flex-col gap-[1rem]'>
            ...
            <div className='py-[3rem] px-[3rem] flex flex-col gap-y-[1.5rem]'>
            <h3 className='font-[700] font-basic text-[2rem] max-small:text-[1.8rem] text-[#004658]'>Educational Materials</h3>
            <ul className='text-[1.6rem] max-small:text-[1.4rem] list-disc ml-[2rem] flex flex-col gap-[1rem]'>
            ...
            <div className='py-[3rem] px-[3rem] flex flex-col gap-y-[1.5rem]'>
            <h3 className='font-[700] font-basic text-[2rem] max-small:text-[1.8rem] text-[#004658]'>Workshops and Webinars</h3>
            <ul className='text-[1.6rem] max-small:text-[1.4rem] list-disc ml-[2rem] flex flex-col gap-[1rem]'>
