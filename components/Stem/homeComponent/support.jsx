...
const Support = () => {
    ...
    return(
      <section
      className="w-full font-[400] leading-[3rem] text-[#000] relative bg-gradient-to-b from-[#BAFFE600] to-[#BAFFE6D9]"
     >
       <div className='container py-[12rem]'>
       <h1 className='font-[700] text-[54px] leading-[64px] text-[#004658] text-center'>Support</h1>

       <div className='gridStyle gap-x-[3rem] mt-[5rem]'>
        <div className='bg-[#fff] rounded-[2rem] pt-[3.4rem] pb-[5rem] px-[2rem] flex flex-col gap-y-[1.5rem] relative min-h-[400px]'>
             <Image 
            ...
            />    
            <h3 className='font-[700] font-basic text-[2rem] text-[#004658]'>Technical Support</h3>
            <ul className='text-[1.6rem] list-disc ml-[2rem] flex flex-col gap-y-[0.5rem]'>
       ...
       <Image 
        ...
        <div className='bg-[#fff] rounded-[2rem] pt-[3.4rem] pb-[5rem] px-[2rem] flex flex-col gap-y-[1.5rem] relative min-h-[400px]'>
            ...
            alt="resources available in slumtech"
            />    
            <h3 className='font-[700] font-basic text-[2rem] text-[#004658]'>Project Development Assistance</h3>
            <ul className='text-[1.6rem] list-disc ml-[2rem] flex flex-col gap-y-[0.5rem]'>
       ...
       <Image 
        ...
        <div className='bg-[#fff] rounded-[2rem] pt-[3.4rem] pb-[5rem] px-[2rem] flex flex-col gap-y-[1.5rem] relative min-h-[400px]'>
            ...
            alt="resources available in slumtech"
            />    
            <h3 className='font-[700] font-basic text-[2rem] text-[#004658]'>Mental Health and Well-being</h3>
            <ul className='text-[1.6rem] list-disc ml-[2rem] flex flex-col gap-y-[0.5rem]'>
       ...
       <Image 
        ...
        <div className='bg-[#fff] rounded-[2rem] pt-[3.4rem] pb-[5rem] px-[2rem] flex flex-col gap-y-[1.5rem] relative min-h-[400px]'>
            ...
            alt="resources available in slumtech"
            />    
            <h3 className='font-[700] font-basic text-[2rem] text-[#004658]'>Community Engagement</h3>
            <ul className='text-[1.6rem] list-disc ml-[2rem] flex flex-col gap-y-[0.5rem]'>
