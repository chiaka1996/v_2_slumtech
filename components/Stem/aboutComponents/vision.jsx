...
const Vision = () => {
    ...
    return(
      <div className='w-full'>
        <div className='container text-[1.8rem] leading-[3rem]'>
            {/* vision */}
            <div className='gridStyle gap-x-[10rem] mb-[10rem]'>
                <div className='text-left max-w-[69.1rem] flex items-center '>
                    <div>
                    <h2 className='text-[#004658] font-[700] text-[5.4rem] leading-[6.4rem]'>Our Vision</h2>
                    <p className='mb-[3rem]'>We envision a world where every child, regardless of their socioeconomic background, 
                 ...
                 <div className="relative h-[63.6rem] max-w-[73.5rem] rounded-b-[25px]">
                <Image 
            ...
            <div className='gridStyle gap-x-[10rem]'>
                 <div className="relative h-[63.6rem] max-w-[73.5rem] rounded-t-[25px]">
                <Image 
            ...
            <div className='text-left max-w-[69.1rem] flex items-center '>
                    <div>
                    <h2 className='text-[#004658] font-[700] text-[5.4rem] leading-[6.4rem]'>What We Do</h2>
                    <p className='mb-[3rem]'>We envision a world where every child, regardless of their socioeconomic background, 
                        has access to quality education and resources in STEM fields. Our competition not only
                         showcases potential talent but also promotes critical thinking, 
                        creativity, and collaboration among participants, pushing them to innovate for their communities.
